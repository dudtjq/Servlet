		...
		<section class="contents">
			<div class="information d-flex border border-success">
				<div class="image d-flex mt-3 ml-3">
					<p align="left"><img alt="아이유 앨범 사진" width="170" height="170" src="http://image.genie.co.kr/Y/IMAGE/IMG_ALBUM/081/867/444/81867444_1616662460652_1_600x600.JPG">
					<div class="ml-2">
						<div><h3 class="font-weight-bold">아이유</h3></div>
						<div class="font-weight-bold">EDAM앤터테인먼트</div>
						<div class="font-weight-bold">2008 데뷔</div>
					</div>
				</div>
			</div>
			<article class="singList">
				...
				<tbody>
					...
					<tr>
						<td><%= list.get("id") %></td>
						<td><a href="/jspTemplate/test/test02/test02result.jsp?id=<%= list.get("id") %>"><%= list.get("title") %></a></td>
